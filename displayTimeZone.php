...
/*
	...
	Plugin URI: http://github.com/midhundevasia/wp-display-timezone/
	...
	Copyright 2010-2016  Midhun Devasia  (emails : hello@midhundevasia.com)
...
function tboy_displayTimezone_css() {
	...
	$x = ( is_rtl() ) ? 'left' : 'right';
	$top_pos = (version_compare($wp_v, '3.2', '>=')) ? '0.7em' : '4.5em';
	echo "
	<style type='text/css'>
